...
def main():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            prestamo = registrar_prestamo(usuarios, libros)
        elif opcion == "4":
            devolucion = registrar_devolucion(usuarios, libros) 
        elif opcion == "5":
            for libro in libros:
            ...
            print ("Saliendo del sistema. ¡Gracias por usar la gestión de la biblioteca!")
            break
        else:
            print("Opción no válida, intene de nuevo.")
